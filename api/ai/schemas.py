...
class SkillLevel(BaseModel):
    ...
    level: str = Field(description="The mastery level demonstrated, e.g., 'Beginner', 'Intermediate', 'Advanced', or 'Expert'.")

class ExtractedSkills(BaseModel):
    skills: List[SkillLevel] = Field(description="A list of skills and the mastery levels demonstrated.")
