...
async def process_accomplishment(
    ...
    try:
        ...
        extracted_data = await skill_extractor_chain.ainvoke({"accomplishment": request.accomplishment})
        extracted_skills = extracted_data.skills

        if not extracted_skills:
            return {"message": "No skills were extracted from the accomplishment.", "processed_skills": []}
        ...
        for skill_level in extracted_skills:
            ...
            match_result = await find_skill_match(candidate_skill_name, existing_skill_names)
            ...
            if match_result.is_duplicate:
                ...
                print(f"Match found: '{candidate_skill_name}' is a duplicate of '{final_skill_name}'")
            else:
                ...
                accomplishment_crud.add_new_skill_with_masteries(driver, final_skill_name)
