...
def test_add_dependency():
    graph = SkillGraph()
    prerequisite_skill = Skill('py_basics', 'Python Basics', 'Learn basic syntax and types.')
    target_skill = Skill('py_intermediate', 'Python Intermediate', 'Learn data structures, loops.')
...
def test_isa_relationship():
    ...
    parent_skill = Skill('id_objects', 'Identify Objects', 'Object Identification Category')
